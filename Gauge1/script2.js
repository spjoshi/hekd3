let Dial2 = function (configuration) {
    let that = {}
    ...
    function render(value) {
        ...
        // Place svg element
        svg = d3.select("#main_viz", "#main_viz2").append("svg")
...
let contract2 = new Dial2({
    size: 160,
    labelText: "Contract Status"
});

let commitment2 = new Dial2({
    size: 160,
...
let budget2 = new Dial2({
    size: 160,
    labelText: "Budget Done"
});
// console.log(c1)
// data = [80, 60, 40, 20]
// preStudyObjects = [contract.update(80), document.write(" < br > "), enrollment.update(60), cda, budget]

// data.forEach(element => preStudyObjects.forEach(element2 => element2.update(element)) + "< /br>");
contract2.update(80);
commitment2.update(60);
// document.write("</br>");
cda2.update(40);
budget2.update(20);